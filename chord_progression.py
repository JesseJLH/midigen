...
@app.route('/')
def index():
    return render_template('index.html', keys=chord_midi_values.keys())

# Define a route for handling the form submission
@app.route('/generate', methods=['POST'])
def generate():
    # Get form data
    selected_keys_str = ','.join(request.form.getlist('key'))
    output_file_name = request.form['filename']
...
# Remove any leading or trailing whitespace from the selected keys
    ...
    # Create a MIDI file with the selected chords
    ...
    # Send the MIDI file as a download
